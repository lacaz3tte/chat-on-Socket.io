...
const Chat = () => {
    ...
    return (
      <div className='absolute top-0 left-0 right-0 bottom-0  flex items-center justify-center'>
        <div className='h-2/3 w-1/2 border border-gray-400 rounded-3xl relative'>
            ...
            <div className='flex flex-row justify-between  absolute bottom-0 right-0  h-14 left-0 rounded-3xl'>
              <input 
                ...
                type='text' 
                className='w-full m-2 px-2 bg-white placeholder-stone-900 border rounded-full focus:outline-none h-10'
              ...
              <button 
                ref = {buttonRef}
                className='m-2 px-10 border rounded-full' 
                onClick={()=>{
