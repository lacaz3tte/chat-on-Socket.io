...
const DeleteChat = () => {
  ...
  return (
    <div className='absolute top-0 left-0 right-0 h-16 items-center justify-between flex'>
      <button 
        onClick={() => { deleteChatContext.setDeleteMode(false) }}
      ...
      >
        <svg className="h-8 w-8 inline-block" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1" stroke-linecap="round" stroke-linejoin="round">  <line x1="18" y1="6" x2="6" y2="18" />  <line x1="6" y1="6" x2="18" y2="18" /></svg>
      </button>
      <button
        className="hover:bg-h4 dark:hover:bg-hd4 active:bg-transparent dark:active:bg-transparent rounded-full p-2 transition-all text-h2 dark:text-hd2 hover:text-h1 dark:hover:text-hd1 active:text-h2 dark:active:text-hd2 m-2"
      >
